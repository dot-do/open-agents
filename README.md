# Open Agents (dot-do fork)

> This is a [dot-do](https://github.com/dot-do) fork of [vercel-labs/open-agents](https://github.com/vercel-labs/open-agents). It tracks upstream and adds multitenant deploy primitives (per-tenant quotas, isolated sandbox limits, Stripe-ready billing hooks) on top of the reference app. For the vanilla single-tenant experience, use the upstream repo. See [docs/SELF_HOST_MULTITENANT.md](docs/SELF_HOST_MULTITENANT.md) and [docs/UPSTREAM_SYNC.md](docs/UPSTREAM_SYNC.md).
